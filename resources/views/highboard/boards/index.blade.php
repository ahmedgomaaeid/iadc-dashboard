...
@section('title', 'Board Members Management')

@section('content')
    <div class="page-header">
        <h1 class="page-title">Board Members Management</h1>
        <div>
            <ol class="breadcrumb">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">All Board Members in Your Field</h3>
                    <a href="{{ route('highboard.boards.create') }}" class="btn btn-primary">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped text-nowrap border-bottom">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('highboard.boards.edit', $board) }}" 
                                                   class="btn btn-sm btn-info" title="Edit">
                                                    <i class="fe fe-edit"></i>
                                                </a>
                                                
                                                <form action="{{ route('highboard.boards.toggle-status', $board) }}" 
                                                ...
                                                <form action="{{ route('highboard.login-as-board', $board->id) }}" 
                                                      method="POST" class="d-inline"
                                                ...
                                                <form action="{{ route('highboard.boards.destroy', $board) }}" 
                                                      method="POST" class="d-inline"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8" class="text-center">No board members found in your field.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
