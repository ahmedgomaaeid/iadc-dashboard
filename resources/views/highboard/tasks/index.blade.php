        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('highboard.tasks.create') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="card border-primary mb-3">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-start mb-2">
                                                <h5 class="card-title mb-0">
                                                    <a href="{{ route('highboard.tasks.show', $task) }}" class="text-dark">
                                                        {{ $task->title }}
                                                    </a>
                                                </h5>
                                                @if($task->is_active)
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mt-3">
                                                    ...
                                                    <div class="text-muted small">
                                                        <i class="fe fe-users me-1"></i>{{ $task->committee->name }}
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            <a href="{{ route('highboard.tasks.show', $task) }}" class="btn btn-sm btn-info">
                                                <i class="fe fe-eye me-1"></i>View
                                            </a>
                                            @if($task->highboard_id === Auth::guard('highboard')->id() || $task->board_id)
                                                <div>
                                                    <a href="{{ route('highboard.tasks.edit', $task) }}" class="btn btn-sm btn-warning me-1">
                                                        <i class="fe fe-edit-2"></i>
                                                    </a>
                                                    <form action="{{ route('highboard.tasks.destroy', $task) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this task?');">
                                                        @csrf
                                                        @method('DELETE')
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">Get started by creating a new task for a committee.</p>
                            <a href="{{ route('highboard.tasks.create') }}" class="btn btn-primary mt-3">
                                <i class="fe fe-plus me-2"></i>Create Task
                            </a>
                        </div>
                    @endif
