    ...
    <div class="page-header">
        ...
        <div>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('highboard.tasks.submissions') }}">Submissions</a></li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <h4><a href="{{ route('highboard.tasks.show', $submission->task) }}">{{ $submission->task->title }}</a></h4>
