    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('highboard.profile.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('highboard.dashboard') }}" class="btn btn-secondary">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('highboard.profile.password') }}" method="POST">
                        @csrf
                        @method('PUT')
