        ...
        <div class="col-lg-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ isset($quiz) ? route('highboard.interactive_quizzes.update', $quiz) : route('highboard.interactive_quizzes.store') }}" method="POST" class="row g-3">
                        @csrf
                        @if (isset($quiz))
                            @method('PUT')
                        @endif
                        ...
                        <div class="col-12 d-flex gap-2">
                            ...
                            <a href="{{ route('highboard.interactive_quizzes.index') }}" class="btn btn-outline-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
