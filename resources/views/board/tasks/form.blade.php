    ...
    <div class="row">
        <div class="col-lg-10">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ isset($task) ? route('board.tasks.update', $task) : route('board.tasks.store') }}" 
                          method="POST" 
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="content" id="summernote" class="form-control @error('content') is-invalid @enderror">{{ old('content', $task->content ?? '') }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
