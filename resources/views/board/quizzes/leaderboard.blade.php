        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <a href="{{ route('board.quizzes.leaderboard.export', $quiz) }}" class="btn btn-success">
                        <i class="fas fa-file-excel me-2"></i>Export to Excel
                    </a>
                    <form action="{{ route('board.quizzes.leaderboard.clear', $quiz) }}" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to clear all leaderboard data? This action cannot be undone.');">
                        @csrf
                        @method('DELETE')
                    ...
                    <a href="{{ route('board.quizzes.show', $quiz) }}" class="btn btn-outline-secondary">
