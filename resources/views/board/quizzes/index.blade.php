        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('board.quizzes.create') }}" class="btn btn-primary">
                            ...
                            <tbody>
                                @forelse($quizzes as $quiz)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('board.quizzes.leaderboard', $quiz) }}" class="btn btn-info btn-sm" title="View Leaderboard">
                                            ...
                                            <a href="{{ route('board.quizzes.show', $quiz) }}" class="btn btn-outline-info btn-sm">View</a>
                                            <a href="{{ route('board.quizzes.edit', $quiz) }}" class="btn btn-outline-primary btn-sm">Edit</a>
                                            <form action="{{ route('board.quizzes.toggle-active', $quiz) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('PATCH')
                                            ...
                                            <form action="{{ route('board.quizzes.destroy', $quiz) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
