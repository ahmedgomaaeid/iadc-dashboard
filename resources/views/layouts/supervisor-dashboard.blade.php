            ...
            <div class="app-header header sticky">
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <!-- sidebar-toggle-->
                        <a class="logo-horizontal " href="{{route('supervisor.dashboard')}}">
                                        ...
                                        <div class="dropdown d-flex profile-1">
                                            <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
                                                @if(Auth::guard('supervisor')->user()->image)
                                                    <img src="{{ asset('storage/' . Auth::guard('supervisor')->user()->image) }}" alt="profile-user"
                                                        class="avatar profile-user brround cover-image">
                                                @else
                                                    <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::guard('supervisor')->user()->name) }}&size=200&background=random" alt="profile-user"
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                <div class="drop-heading">
                                                    <div class="text-center">
                                                        <h5 class="text-dark mb-0 fs-14 fw-semibold">{{ Auth::guard('supervisor')->user()->name }}</h5>
                ...
                <div class="sticky">
                    ...
                    <div class="app-sidebar">
                        <div class="side-header">
                            <a class="header-brand1" href="{{route('supervisor.dashboard')}}" style="width: 150px;">
                            ...
                            <div class="main-sidemenu">
                                ...
                                <ul class="side-menu">
                                    ...
                                    <li class="slide">
                                        <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{route('supervisor.dashboard')}}"><i
                                    ...
                                    <li class="slide">
                                        <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{route('supervisor.email.inbox')}}"><i
                                                class="side-menu__icon fe fe-mail"></i><span
                                                class="side-menu__label">Email</span></a>
                                    </li>
                                    ...
                                    <li class="slide">
                                        <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('supervisor.profile.edit') }}"><i
                                    ...
                                    <li class="slide">
                                        <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{route('supervisor.logout')}}"><i
