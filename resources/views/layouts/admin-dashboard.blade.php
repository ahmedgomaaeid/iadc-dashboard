                ...
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        {{-- <a class="logo-horizontal " href="{{route('index')}}">
                            <img src="{{$company->logo}}" class="header-brand-img desktop-logo" alt="logo" style="height: 60px;">
                            <img src="{{$company->logo}}" class="header-brand-img light-logo1"
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                <div class="drop-heading">
                                                    <div class="text-center">
                                                        ...
                                                        <small class="text-muted">userPosition($user)</small>
                                                    </div>
                                                </div>
                ...
                <div class="sticky">
                    ...
                    <div class="app-sidebar">
                        <div class="side-header">
                            {{-- <a class="header-brand1" href="{{route('admin.dashboard')}}" style="height: 67px; width:67px;">
                                <img src="{{$company->logo}}" class="header-brand-img desktop-logo" alt="logo" style="height: 100%;">
                                <img src="{{$company->logo}}" class="header-brand-img toggle-logo"
                                    alt="logo" style="height: 100%;">
                                <img src="{{$company->logo}}" class="header-brand-img light-logo" alt="logo" style="height: 100%;">
                                <img src="{{$company->logo}}" class="header-brand-img light-logo1"
                                    alt="logo" style="height: 100%;">
                            </a> --}}
                            <!-- LOGO -->
