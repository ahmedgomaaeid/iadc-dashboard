                    ...
                    <div class="container-fluid main-container">
                        <div class="d-flex">
                            ...
                            <a class="logo-horizontal " href="index.html">
                                ...
                                <img src="{{route('index')}}/assets/images/brand/logo-3.png" class="header-brand-img light-logo1"
                                    alt="logo">
                            </a>
                            <!-- LOGO -->
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="main-sidemenu navbar px-0">
                                        <a class="navbar-brand ps-0 d-none d-lg-block" style="width: 150px;" href="{{ route('index') }}">
                                            <img alt="" class="logo-2" src="{{route('index')}}/assets/images/brand/logo-3.png">
                                        </a>
                                            ...
                                            <div class="row mt-7">
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="card features main-features main-features-1 wow fadeInUp reveal revealleft" data-wow-delay="0.1s">
                                                        <div class="bg-img mb-2 text-left">
                                                            <!-- <img src="{{route('index')}}/assets/landing/images/features/quality-59.png" alt=""> -->
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="card  features main-features main-features-2 wow fadeInUp reveal revealleft" data-wow-delay="0.1s">
                                                        <div class="bg-img mb-2 text-left">
                                                            <!-- <img src="{{route('index')}}/assets/landing/images/features/demo.png" alt=""> -->
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-6 col-lg-6 ps-0">
                                                                    <div class="text-center reveal revealleft mb-3" >
                                                                        <img src="{{route('index')}}/assets/images/landing/business-team-working-on-business-plan.png" alt="" class="br-5">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row justify-content-center">
                                                            <div class="col-lg-12 px-0">
                                                                <div class="feature-logos mt-5">
                                                                    <div class="slide">
                                                                        <img src="{{route('index')}}/assets/images/landing/web/1.png">
                                                                        <h5 class="mt-3 text-white">Bootstrap5</h5>
                                                                    </div>
                                                                    <div class="slide">
                                                                        <img src="{{route('index')}}/assets/images/landing/web/2.png">
                                                                        <h5 class="mt-3 text-white">HTML5</h5>
                                                                    </div>
                                                                    <div class="slide">
                                                                        <img src="{{route('index')}}/assets/images/landing/web/3.png">
                                                                        <h5 class="mt-3 text-white">JQuery</h5>
                                                                    </div>
                                                                    <div class="slide">
                                                                        <img src="{{route('index')}}/assets/images/landing/web/4.png">
                                                                        <h5 class="mt-3 text-white">Sass</h5>
                                                                    </div>
                                                                    <div class="slide">
                                                                        <img src="{{route('index')}}/assets/images/landing/web/5.png">
                                                                        <h5 class="mt-3 text-white">Gulp</h5>
                                                                    </div>
                                                                    <div class="slide">
                                                                        <img src="{{route('index')}}/assets/images/landing/web/6.png">
                                            ...
                                            <section class="sptb demo-screen-demo" id="faqs">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-12 col-lg-6 reveal revealright">
                                                        <img src="{{route('index')}}/assets/images/landing/frequently-asked-questions.png" alt="">
                                                    </div>
                                                </div>
                                            </section>
                                        </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="card bg-transparent reveal">
                                                    <div class="card-body px-1">
                                                        <div class="d-flex overflow-visible">
                                                            <a href="blog-details.html" class="card-aside-column br-5 cover-image" data-bs-image-src="{{route('index')}}/assets/images/media/12.jpg" style="background: url(&quot;{{route('index')}}/assets/images/media/12.jpg&quot;) center center;"></a>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="card bg-transparent reveal">
                                                    <div class="card-body px-1">
                                                        <div class="d-flex overflow-visible">
                                                            <a href="blog-details.html" class="card-aside-column br-5 cover-image" data-bs-image-src="{{route('index')}}/assets/images/media/22.jpg" style="background: url(&quot;{{route('index')}}/assets/images/media/22.jpg&quot;) center center;"></a>
                                                            <div class="ps-3 flex-column">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="card bg-transparent reveal">
                                                    <div class="card-body px-1">
                                                        <div class="d-flex overflow-visible">
                                                            <a href="blog-details.html" class="card-aside-column br-5 cover-image" data-bs-image-src="{{route('index')}}/assets/images/media/about.jpg" style="background: url(&quot;{{route('index')}}/assets/images/media/about.jpg&quot;) center center;"></a>
                                                            <div class="ps-3 flex-column">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="card bg-transparent reveal">
                                                    <div class="card-body px-1">
                                                        <div class="d-flex overflow-visible">
                                                            <a href="blog-details.html" class="card-aside-column br-5 cover-image" data-bs-image-src="{{route('index')}}/assets/images/media/25.jpg" style="background: url(&quot;{{route('index')}}/assets/images/media/25.jpg&quot;) center center;"></a>
                                                            <div class="ps-3 flex-column">
                                ...
                                <div class="top-footer">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-sm-12 col-md-4 reveal revealleft">
                                            <div class="">
                                                <a href="index.html"><img loading="lazy" alt="" class="logo mb-3" src="{{route('index')}}/assets/images/brand/logo-3.png"></a>
