        ...
        <div class="col-lg-12">
            <div class="d-flex align-items-center justify-content-between mb-3">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('admin.interactive_quizzes.leaderboard', $quiz) }}" class="btn btn-info">
                        <i class="fas fa-trophy me-1"></i> Leaderboard
                    </a>
                    <form action="{{ route('admin.interactive_quizzes.toggle-active', $quiz) }}" method="POST">
                        @csrf
                        @method('PATCH')
                    ...
                    <a href="{{ route('admin.interactive_quizzes.index') }}" class="btn btn-outline-secondary">Back</a>
                </div>
            </div>
