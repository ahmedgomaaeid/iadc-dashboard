...
@section('content')
    <div class="page-header">
        <h1 class="page-title">WellSharp Quiz Questions</h1>
        <div>
            <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
            <div class="d-flex align-items-center justify-content-between mb-3">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('admin.wellsharp_quizzes.control', $quiz) }}" class="btn btn-info">
                        <i class="fas fa-gamepad me-1"></i> Control Panel
                    </a>
                    <a href="#" class="btn btn-outline-danger" id="copyPresentLink" data-clipboard-text="{{ route('wellsharp.present', $quiz) }}">
                        <i class="fas fa-copy me-1"></i> Copy Presentation Link
                    </a>
                    <form action="{{ route('admin.wellsharp_quizzes.toggle-active', $quiz) }}" method="POST">
                        @csrf
                        @method('PATCH')
                    ...
                    <a href="{{ route('admin.wellsharp_quizzes.index') }}" class="btn btn-outline-secondary">Back</a>
                </div>
            </div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-striped align-middle mb-0">
                            ...
                            <tbody>
                                @forelse ($quiz->questions->sortBy('id')->values() as $index => $question)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="{{ route('admin.questions.edit', $question) }}" class="btn btn-outline-primary btn-sm">Edit</a>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center text-muted py-4">No questions yet. Add your first question.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
...
@section('scripts')
    ...
    <script>
        document.getElementById('copyPresentLink').addEventListener('click', function(e) {
            e.preventDefault();
