...
class QuestionController extends Controller
{
    ...
    {
        return redirect()->route('board.quizzes.show', $quiz);
    }
    /**
    ...
    {
        return view('board.questions.create', compact('quiz'));
    }
    ...
    public function store(Request $request, Quiz $quiz)
    {
        ...
        return redirect()->route('board.quizzes.show', $quiz)->with('success', 'Question added successfully.');
    }
    ...
    public function update(Request $request, Question $question)
    {
        ...
        return redirect()->route('board.quizzes.show', $question->quiz)->with('success', 'Question updated successfully.');
    }
    ...
    public function destroy(Question $question)
    {
        ...
        return redirect()->route('board.quizzes.show', $quiz)->with('success', 'Question deleted successfully.');
    }
}
