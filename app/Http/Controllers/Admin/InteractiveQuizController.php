...
class InteractiveQuizController extends Controller
{
    public function index()
    {
        ...
        return view('admin.interactive_quizzes.index', compact('quizzes'));
    }

    public function create()
    {
        $committees = Committee::active()->get();
        return view('admin.interactive_quizzes.create', compact('committees'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.interactive_quizzes.show', $quiz)->with('success', 'Interactive Quiz created successfully.');
    }

    public function show(Quiz $interactive_quiz)
    {
        return view('admin.interactive_quizzes.show', ['quiz' => $interactive_quiz]);
    }

    public function edit(Quiz $interactive_quiz)
    {
        $committees = Committee::active()->get();
        return view('admin.interactive_quizzes.edit', ['quiz' => $interactive_quiz, 'committees' => $committees]);
    }
    ...
    public function update(Request $request, Quiz $interactive_quiz)
    {
        ...
        return redirect()->route('admin.interactive_quizzes.index')->with('success', 'Interactive Quiz updated successfully.');
    }
    ...
    public function destroy(Quiz $interactive_quiz)
    {
        ...
        return redirect()->route('admin.interactive_quizzes.index')->with('success', 'Interactive Quiz deleted successfully.');
    }
    ...
    {
        return view('admin.interactive_quizzes.leaderboard', ['quiz' => $interactive_quiz]);
    }
